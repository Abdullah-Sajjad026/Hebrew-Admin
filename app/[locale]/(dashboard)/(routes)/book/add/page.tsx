...
export default function Page() {
  ...
  const onStudySubmission = async (values: DailyStudiesFormState) => {
    ...
    */
    ...
    const folderRef = ref(fireStorage, "book");

    const dailyStudiesCollection = collection(firestore, "book");
    ...
    try {
      ...
      try {
        ...
        console.log("book file cover image uploaded");
        ...
        if (values.pdf) {
          ...
          console.log("book file pdf uploaded");
